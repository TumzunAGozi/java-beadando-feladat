...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Jan 24. 17:51
...
(4, 'aaa', 'aaa@aaa.hu', '$2a$10$1I1qGQ/Z6005JY.WRzRrxOIjrVlwp0zIYEHgEfh6TJfvSKeR4NdN6', 'ROLE_Vendeg'),
(5, 'bbb', 'bbb@gmail.com', '$2a$10$1jEjWMKVenumq1x1kbaGTOimdsIZj6ckNUYrB1ZShvGs1k5e7u1CK', 'ROLE_Vendeg');
...
--
-- Tábla szerkezet ehhez a táblához `uzenet_osztaly`
--

CREATE TABLE `uzenet_osztaly` (
...
ALTER TABLE `telepules`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FKlkmmvg398c1pyiockt1tisi4y` (`npid`);
...
--
-- A tábla indexei `uzenet_osztaly`
--
ALTER TABLE `uzenet_osztaly`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT a táblához `uzenet_osztaly`
--
ALTER TABLE `uzenet_osztaly`
...
--
ALTER TABLE `telepules`
  ADD CONSTRAINT `FKlkmmvg398c1pyiockt1tisi4y` FOREIGN KEY (`npid`) REFERENCES `np` (`id`);
COMMIT;
